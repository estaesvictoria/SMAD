...
BEGIN Scenario
    ...
    BEGIN Epoch
        ...
        Epoch		 1 Feb 2021 09:00:00.000000000
        SmartEpoch		
        BEGIN EVENT
            Epoch		 1 Feb 2021 09:00:00.000000000
            EventEpoch		
    ...
    BEGIN Interval
        ...
        Start		 1 Feb 2021 09:00:00.000000000
        Stop		 10 Feb 2021 09:00:00.000000000
        SmartInterval		
        BEGIN EVENTINTERVAL
            BEGIN Interval
                Start		 1 Feb 2021 09:00:00.000000000
...
"1 Feb 2021 09:00:00.000000000" "2 Feb 2021 09:00:00.000000000"
                        END Intervals
...
"1 Feb 2021 09:00:00.000000000" "1 Feb 2021 09:00:00.000000000"
                        END Intervals
...
"1 Feb 2021 09:00:00.000000000" "1 Feb 2021 09:00:00.000000000"
    ...
    BEGIN Extensions
        ...
        BEGIN ClsApp
            ...
            LaunchWindowStart		 1468800
            LaunchWindowStop		 777600
            LaunchMETOffset		 0
            ...
            BEGIN EVENTINTERVAL
                BEGIN Interval
                    Start		 18 Feb 2021 09:00:00.000000000
                    Stop		 19 Feb 2021 09:00:00.000000000
                END Interval
                IntervalState		 Explicit
            END EVENTINTERVAL
...
<SCOPE>
    <VAR name = "ClutterMap">
        ...
        BEGIN Graphics
            ...
            BEGIN Animation
                ...
                StartTime		 1 Feb 2021 09:00:00.000000000
                EndTime		 10 Feb 2021 09:00:00.000000000
                CurrentTime		 1 Feb 2021 09:00:00.000000000
                Direction		 Forward
                UpdateDelta		 30
            ...
            BEGIN MapData
                ...
                BEGIN Map
                    ...
                    BEGIN RecordMovie
                        OutputFormat		 WMV
                        SdfSelected		 No
                        Directory		 C:\Users\vikak\Desktop\Coverage
                        BaseName		 Frame
                        Digits		 4
                        Frame		 0
                        LastAnimTime		 0
    ...
    BEGIN References
        ...
        Instance CoverageDefinition/CoverageDefinition2
            CoverageDefinition/CoverageDefinition2		
        END Instance
        Instance Facility/ConstTemplate
            CoverageDefinition/CoverageDefinition2		
            Facility/ConstTemplate		
        END Instance
        Instance Satellite/LANDSAT_7_25682
            Satellite/LANDSAT_7_25682		
            Satellite/LANDSAT_7_25682/Sensor/Sensor2		
        END Instance
        Instance Satellite/LANDSAT_7_25682/Sensor/Sensor2
            CoverageDefinition/CoverageDefinition2		
            Satellite/LANDSAT_7_25682/Sensor/Sensor2		
        END Instance
        Instance Satellite/LANDSAT_8_39084
            Satellite/LANDSAT_8_39084		
            Satellite/LANDSAT_8_39084/Sensor/Sensor1		
        END Instance
        Instance Satellite/LANDSAT_8_39084/Sensor/Sensor1
            CoverageDefinition/CoverageDefinition2		
            Satellite/LANDSAT_8_39084/Sensor/Sensor1		
        END Instance
    END References
